...
DROP TABLE IF EXISTS PRODUCTO CASCADE;           -- Ahora PRODUCTO está libre para destruirse
DROP TABLE IF EXISTS CATEGORIA CASCADE;          -- Destrucción de la nueva entidad maestra
